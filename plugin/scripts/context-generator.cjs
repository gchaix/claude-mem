"use strict";var jt=Object.create;var j=Object.defineProperty;var Gt=Object.getOwnPropertyDescriptor;var Bt=Object.getOwnPropertyNames;var Xt=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var Kt=(r,e)=>{for(var t in e)j(r,t,{get:e[t],enumerable:!0})},Ie=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Bt(e))!Wt.call(r,n)&&n!==t&&j(r,n,{get:()=>e[n],enumerable:!(s=Gt(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?jt(Xt(r)):{},Ie(e||!r||!r.__esModule?j(t,"default",{value:r,enumerable:!0}):t,r)),Yt=r=>Ie(j({},"__esModule",{value:!0}),r);var Is={};Kt(Is,{generateContext:()=>Oe,generateContextWithStats:()=>te});module.exports=Yt(Is);var Ft=U(require("path"),1),$t=require("os"),Ht=require("fs");var ue=require("bun:sqlite");var T=require("path"),oe=require("os"),D=require("fs");var Le=require("url");var L=require("fs"),Ne=require("path");var Vt=null;function qt(r){return(Vt??process.stderr.write.bind(process.stderr))(r)}function se(r){qt(r)}var re=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(re||{}),ne=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=re[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=re[e].padEnd(5),d=t.padEnd(6),u="";n?.correlationId?u=`[${n.correlationId}] `:n?.sessionId&&(u=`[session-${n.sessionId}] `);let m="";if(o!=null)if(o instanceof Error)m=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{m=`
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let g="";if(n){let{sessionId:E,memorySessionId:f,correlationId:b,...p}=n;Object.keys(p).length>0&&(g=` {${Object.entries(p).map(([h,S])=>`${h}=${S}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${u}${s}${g}${m}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,l+`
`,"utf8")}catch(E){se(`[LOGGER] Failed to write to log file: ${E instanceof Error?E.message:String(E)}
`)}else se(l+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}error(e,t,s,n){this.log(3,e,t,s,n)}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}timing(e,t,s,n){this.info(e,`\u23F1 ${t}`,n,{duration:`${s}ms`})}happyPathError(e,t,s,n,o=""){let u=((new Error().stack||"").split(`
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=u?`${u[1].split("/").pop()}:${u[2]}`:"unknown",g={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},c=new ne;var os={};function Jt(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Le.fileURLToPath)(os.url))}var Qt=Jt();function zt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,oe.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=zt(),y=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,oe.homedir)(),".claude"),xs=(0,T.join)(y,"plugins","marketplaces","thedotmack"),Zt=(0,T.join)(R,"archives"),es=(0,T.join)(R,"logs"),ts=(0,T.join)(R,"trash"),ss=(0,T.join)(R,"backups"),rs=(0,T.join)(R,"modes"),ws=(0,T.join)(R,"settings.json"),Me=(0,T.join)(R,"claude-mem.db"),ns=(0,T.join)(R,"vector-db"),De=(0,T.join)(R,"observer-sessions"),ie=(0,T.basename)(De),Ps=(0,T.join)(y,"settings.json"),ks=(0,T.join)(y,"commands"),Fs=(0,T.join)(y,"CLAUDE.md");function ye(r){(0,D.mkdirSync)(r,{recursive:!0})}function ve(){return(0,T.join)(Qt,"..")}var x={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),serverBetaPid:()=>(0,T.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(R,".server-beta.runtime.json"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>es,archives:()=>Zt,trash:()=>ts,backups:()=>ss,modes:()=>rs,vectorDb:()=>ns,observerSessions:()=>De};var Fe=require("crypto");var xe=require("os"),we=U(require("path"),1),Pe=require("child_process");var B=require("fs"),G=U(require("path"),1);var w={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Ue(r){let e=G.default.join(r,".git"),t;try{t=(0,B.statSync)(e)}catch(m){return m instanceof Error&&m.code!=="ENOENT"&&c.warn("GIT","Unexpected error checking .git",{error:m instanceof Error?m.message:String(m)}),w}if(!t.isFile())return w;let s;try{s=(0,B.readFileSync)(e,"utf-8").trim()}catch(m){return c.warn("GIT","Failed to read .git file",{error:m instanceof Error?m.message:String(m)}),w}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return w;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return w;let a=i[1],d=G.default.basename(r),u=G.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:u}}function ke(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,xe.homedir)()):r}function is(r){try{return(0,Pe.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function as(r){if(!r||r.trim()==="")return c.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ke(r),s=is(e)??e,n=we.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return c.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return c.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function ae(r){let e=as(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=ke(r),s=Ue(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function X(r,e,t){return(0,Fe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function ds(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return A;let e=ds(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function $e(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function He(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(e,t,n)??void 0}var Be=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],je=new RegExp(`<(${Be.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Xe=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Ge=100;function _s(r){let e=Object.fromEntries(Be.map(n=>[n,0]));je.lastIndex=0;let t=0,s=r.replace(je,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Ge&&c.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Ge,contentLength:r.length}),{stripped:s.trim(),counts:e}}function We(r){return _s(r).stripped}var us=["task-notification"],Zs=new RegExp(`^\\s*<(${us.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),er=256*1024;var _e=4e3;function W(r){let e=r.trim(),s=We(r).trim()||e;return s.length<=_e?s:(c.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:_e}),`${s.slice(0,_e-1)}\u2026`)}function cs(r,e,t){return{customTitle:r,platformSource:e?v(e):void 0,hostname:t?.trim()||void 0}}var K=class{db;constructor(e=Me){e instanceof ue.Database?this.db=e:(e!==":memory:"&&ye(R),this.db=new ue.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.addSessionHostnameColumn()}addSessionHostnameColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(37),s=this.db.query("PRAGMA table_info(sdk_sessions)").all().some(n=>n.name==="hostname");e&&s||(s||(this.db.run("ALTER TABLE sdk_sessions ADD COLUMN hostname TEXT"),c.debug("DB","Migration 37: added hostname column to sdk_sessions table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(37,new Date().toISOString()))}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),c.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){c.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),c.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),c.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,u=s==="relevance",m=u?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),E=[...e],f=[];if(o&&(f.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let S=i.map(()=>"?").join(",");f.push(`type IN (${S})`),E.push(...i)}else f.push("type = ?"),E.push(i);if(a){let S=Array.isArray(a)?a:[a],C=S.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...S),f.push(`(${C.join(" OR ")})`)}if(d){let S=Array.isArray(d)?d:[d],C=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");S.forEach(M=>{E.push(`%${M}%`,`%${M}%`)}),f.push(`(${C.join(" OR ")})`)}let b=f.length>0?`WHERE id IN (${l}) AND ${f.join(" AND ")}`:`WHERE id IN (${l})`,O=this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
      ${m}
      ${g}
    `).all(...E);if(!u)return O;let h=new Map(O.map(S=>[S.id,S]));return e.map(S=>h.get(S)).filter(S=>!!S)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o,i){let a=new Date,d=a.getTime(),u=cs(n,o,i),m=u.platformSource??A,g=W(s),l=this.db.prepare(`
    ...
    `).get(e);if(l){if(t&&this.db.prepare(`
        ...
        `).run(t,e),u.customTitle&&this.db.prepare(`
          UPDATE sdk_sessions SET custom_title = ?
          WHERE content_session_id = ? AND custom_title IS NULL
        `).run(u.customTitle,e),u.platformSource){let f=l.platform_source?.trim()?v(l.platform_source):void 0;if(!f)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(u.platformSource,e);else if(f!==u.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${f}, received=${u.platformSource}`)}return u.hostname&&this.db.prepare(`
          UPDATE sdk_sessions SET hostname = ?
          WHERE content_session_id = ?
            AND COALESCE(hostname, '') = ''
        `).run(u.hostname,e),l.id}return this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,m,u.hostname||null,g,u.customTitle||null,a.toISOString(),d),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s){let n=new Date,o=n.getTime(),i=W(s);return this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),u=new Date(d).toISOString(),m=X(e,s.title,s.narrative),l=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,m,u,d,a||null,s.metadata??null);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let E=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,m);if(!E)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${m}`);return{id:E.id,createdAtEpoch:E.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let u=a??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let l=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let O=X(e,p.title,p.narrative),h=E.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,O,m,u,d||null);if(h){l.push(h.id);continue}let S=f.get(e,O);if(!S)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${O}`);l.push(S.id)}let b=null;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,u);b=Number(O.lastInsertRowid)}return{observationIds:l,summaryId:b,createdAtEpoch:u}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,u,m){let g=u??Date.now(),l=new Date(g).toISOString();return this.db.transaction(()=>{let f=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),p=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let C of s){let M=X(e,C.title,C.narrative),Ae=b.get(e,t,C.type,C.title,C.subtitle,JSON.stringify(C.facts),C.narrative,JSON.stringify(C.concepts),JSON.stringify(C.files_read),JSON.stringify(C.files_modified),a||null,d,C.agent_type??null,C.agent_id??null,M,l,g,m||null);if(Ae){f.push(Ae.id);continue}let Ce=p.get(e,M);if(!Ce)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${M}`);f.push(Ce.id)}let O;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,g);O=Number(M.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
        WHERE id = ? AND status = 'processing'
      `).run(o).changes!==1)throw new Error(`storeObservationsAndMarkComplete: failed to complete pending message ${o}`);return{observationIds:f,summaryId:O,createdAtEpoch:g}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],g=o?`WHERE id IN (${u}) AND project = ?`:`WHERE id IN (${u})`;o&&m.push(o);let E=this.db.prepare(`
      SELECT * FROM session_summaries
      ${g}
      ${a}
      ${d}
    `).all(...m);if(!i)return E;let f=new Map(E.map(b=>[b.id,b]));return e.map(b=>f.get(b)).filter(b=>!!b)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],g=o?"AND s.project = ?":"";o&&m.push(o);let E=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...m);if(!i)return E;let f=new Map(E.map(b=>[b.id,b]));return e.map(b=>f.get(b)).filter(b=>!!b)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,u;if(e!==null){let p=`
...
`):null}function Ts(r,e,t,s){let n=[];n.push(...it(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=he(a.displayTime);n.push(...ut(a,d))}else{let a=i.data,d=Re(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let l=vt(a,s);n.push(..._t(a,m,l,s))}else n.push(dt(a,m,s))}return n}function fs(r,e,t,s,n){let o=[];o.push(...bt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let u=d.data,m=he(u.displayTime);o.push(...At(u,m))}else{let u=d.data,m=yt(u.files_modified,n,u.files_read),g=Re(u.created_at),l=g!==a;a=g;let E=t.has(u.id);if(m!==i&&(o.push(...ht(m)),i=m),E){let f=vt(u,s);o.push(...Ot(u,g,l,f,s))}else o.push(Rt(u,g,l,s))}return o.push(""),o}function Ss(r,e,t,s,n,o){return o?fs(r,e,t,s,n):Ts(r,e,t,s)}function Ut(r,e,t,s,n){let o=[],i=gs(r);for(let[a,d]of i)o.push(...Ss(a,d,e,t,s,n));return o}function xt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function wt(r,e){let t=[];return e?(t.push(...H("Investigated",r.investigated,_.blue)),t.push(...H("Learned",r.learned,_.yellow)),t.push(...H("Completed",r.completed,_.green)),t.push(...H("Next Steps",r.next_steps,_.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function Pt(r,e){return e?Ct(r):ct(r)}function kt(r,e,t){return!J(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?It(r.totalDiscoveryTokens,r.totalReadTokens):mt(r.totalDiscoveryTokens,r.totalReadTokens)}var bs=Ft.default.join((0,$t.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function hs(){try{return new K}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ht.unlinkSync)(bs)}catch(e){e instanceof Error?c.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):c.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return c.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Rs(r,e){return e?Nt(r):pt(r)}function Os(r,e,t,s,n,o,i){let a=[],d=q(e);a.push(...Lt(r,d,s,i));let u=t.slice(0,s.sessionCount),m=ze(u,t),g=Se(e,m),l=Ze(e,s.fullObservationCount);a.push(...Ut(g,l,s,n,i));let E=t[0],f=e[0];xt(s,E,f)&&a.push(...wt(E,i));let b=fe(e,s,o,n);return a.push(...Pt(b,i)),a.push(...kt(d,s,i)),a.join(`
`).trimEnd()}var As=new Set(["bugfix","discovery","decision","refactor"]);function Cs(r,e,t){let s=q(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let u=As.has(d.type)?d.type:"other";n[u]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function te(r,e=!1){let t=pe(),s=r?.cwd??process.cwd(),n=ae(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=hs();if(!a)return{text:"",stats:null};try{let d=o.length>1?qe(a,o,t):ge(a,i,t),u=o.length>1?Je(a,o,t):Te(a,i,t);return d.length===0&&u.length===0?{text:Rs(i,e),stats:null}:{text:Os(i,d,u,t,s,r?.session_id,e),stats:Cs(d,u,!!r?.full)}}finally{a.close()}}async function Oe(r,e=!1){return(await te(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
