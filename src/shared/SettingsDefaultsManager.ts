...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENROUTER_BASE_URL: string;  // API endpoint URL (default: OpenRouter; set to http://localhost:11434/v1/chat/completions for Ollama)
  CLAUDE_MEM_OPENROUTER_MODEL: string;
  CLAUDE_MEM_OPENROUTER_SITE_URL: string;
  CLAUDE_MEM_OPENROUTER_APP_NAME: string;
  CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES: string;
  CLAUDE_MEM_OPENROUTER_MAX_TOKENS: string;
  CLAUDE_MEM_OPENROUTER_BATCH_SIZE: string;  // Concurrent LLM requests per batch (for Ollama OLLAMA_NUM_PARALLEL)
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_BASE_URL: 'https://openrouter.ai/api/v1/chat/completions',  // Override for local LLM (e.g. http://localhost:11434/v1/chat/completions for Ollama)
